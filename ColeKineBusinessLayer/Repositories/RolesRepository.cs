...
namespace ColeKineBusinessLayer.Repositories
{
        ...
        where TEntity : IdentityRole where TEntity2 : RoleDetails
    {
        ...
        {
            RoleDetails role =  _context.DetallesRoles.Find(roleId);
            Permission _permission =  _context.Permisos.Find(permissionId);
        ...
        {
            RoleDetails role =  _context.DetallesRoles.Find(id);
            Permission permission =  _context.Permisos.Find(permissionId);
